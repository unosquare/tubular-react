...
const rows = [
    createData(
        'Tubular for AngularJS (formerly Tubular)',
        'Library',
        'AngularJs',
    ...
    createData(
        'Tubular for Angular6 (formerly Tubular2)',
        'Library',
        'Angular6',
    ...
    return (
        <Grid container={true} className={classes.container}>
            <Paper className={classes.paper}>
                ...
                <Divider />
                <Typography paragraph={true} variant="subtitle1" className={classes.content}>
                    Tubular React is a set of ReactJS components designed to rapidly build modern web applications. The
                    centerpiece of Tubular is its fully templated grid with lots of features such as server-side
                    pagination, searching text, multi-column sorting, and Filterable, built-in export to CSV or been
                    printed. Another very styled and useful component is the grid list that renders a set of cards with
                    the general information allowing good data visualization and quickly searching, besides it has
                    almost the same grid functionalities.
                </Typography>
                <br />
                ...
                <Typography paragraph={true} variant="subtitle1" className={classes.content}>
                    ...
                    <ul>
                        ...
                        <li>
                            Use a remote or local datasource. Remote datasource use a specific Request and Response
                            format.
                        </li>
                    ...
                    <br />
                    The <em>grid list</em> component represents another option to show your data.
                    <br />
                    <em>Grid list</em> provide a styled and fancy view over your data, which helps you to quickly find
                    information.
                    <br />
                </Typography>
                ...
                <Typography variant="subtitle1" paragraph={true}>
                    ...
                    <a href="https://www.npmjs.com/package/tubular-react" target="_blank" className={classes.link}>
                        npm package
                    </a>
                </Typography>
                ...
                <Typography variant="body1" paragraph={true}>
                    <ul>
                        <li>
                            <a href="https://date-fns.org/" className={classes.link}>
                                date-fns - Version: 1.29.0
                            </a>
                        </li>
                        <li>
                ...
                <Divider />
                <Typography variant="subtitle1" paragraph={true}>
                    Tubular React is an extension of Material-UI which offers until now a couple of useful components:
                    <br />
                    <code className={classes.codeTag}>{'<DataGrid />'}</code> and
                    <code className={classes.codeTag}>{'<GridList />'}</code>.
                    <br />
                    These components supply an organized and nice way to represent your data, you can populate them from
                    a server-side data source or a local data source as an array.
                </Typography>
                <Typography variant="h5" paragraph={true}>
                    Quick Start
                </Typography>
                ...
                <Typography variant="subtitle1" paragraph={true}>
                    You can add functionalities to the `DataGrid`, including extra buttons that can perform an action
                    according to your requirements. You just need to include the IconButton Component from @material-ui
                    and define the icon or button that you need between `DataGrid` tags and specify the action to
                    perform.
                    <br />
                    <Highlight language="javascript" className={classes.code}>
                        {`
