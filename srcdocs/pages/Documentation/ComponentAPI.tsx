        ...
        <Grid container={true} className={classes.container}>
            ...
            <Grid item={true} xs={12}>
                <Paper className={classes.paper}>
                    ...
                    <Typography variant="subtitle1">
                        ...
                        <code className={classes.codeTag}>withLocalDataSource</code> according to the case to fill the{' '}
                        <code className={classes.codeTag}>{'<DataGrid />'}</code> component with the data.
                        <br />
                    ...
                    <Typography variant="subtitle1">
                        <i>
                            If you don't define some of the optional props described above, these will not be shown. In
                            the case of{' '}
                        </i>
                        ...
                        <i>
                            ...
                            is not defined, the footer will not be displayed.
                        </i>
                    </Typography>
                </Paper>
            </Grid>
            <Grid item={true} xs={12}>
                <Paper className={classes.paper}>
                    ...
                    <br />
                    <Typography variant="subtitle1">
                        Use this component with <code className={classes.codeTag}>{'<DataGridTable />'}</code> to use a
                        custom layout in your grid. It's important to use{' '}
                        <code className={classes.codeTag}>withRemoteDataSource</code> or{' '}
                        <code className={classes.codeTag}>withLocalDataSource</code>
                        according to the case to fill the{' '}
                        <code className={classes.codeTag}>{'<DataGridProvider />'}</code>
                    ...
                    <br />
                    <Typography variant="subtitle1">
                        <i>If you don't define some of the optional props described above, these will not be shown.</i>
                    </Typography>
                </Paper>
            </Grid>
            <Grid item={true} xs={12}>
            ...
            <Grid item={true} xs={12}>
                <Paper className={classes.paper}>
                    ...
                    <br />
                    <Typography variant="subtitle1">
                        <code className={classes.codeTag}>{'<DataGrid />'}</code> requires a wrapper component to
                        retrieve data. Depends on if we use a local data source or a remote data source, these wrappers
                        are:
                        ...
                        array and a <code className={classes.codeTag}>URL</code> which represent a service.
                        <br />
                        ...
                        needs our <code className={classes.codeTag}>DataGrid</code>
                        component, a <code className={classes.codeTag}>ColumnModel</code>
                        array and an <code className={classes.codeTag}>Array</code>of objects.
                        <br />
                        <Highlight language="javascript" className={'an-old-hope'}>
                            {localDataSource}
                        </Highlight>
            ...
            <Grid item={true} xs={12}>
                <Paper className={classes.paper}>
                    ...
                    <br />
                    <Typography variant="subtitle1">
                        If you need to personalize the grid adding, removing or modifying features,{' '}
                        <code className={classes.codeTag}>ToolBarOptions Class</code>
                    ...
                    <Typography variant="subtitle1">
                        <i>
                            If you don't define some of the optional props described above, these will set with the
                            default values.
                        </i>
                    </Typography>
                </Paper>
