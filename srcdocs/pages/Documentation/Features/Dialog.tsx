...
export default () => {
    ...
    const dialogToolbarDescription =
    `You can add a button on the toolbar to open a dialog or do any other action,
        ...
        <Grid container={true} className={classes.container}>
            <Grid item={true} xs={10} className={classes.paper}>
                ...
                <Typography variant='h6' className={classes.description}>
                    You can add actions to the toolbar and when the user click a row.
                    In this section, you can see these actions opening a dialog.
                </Typography>
