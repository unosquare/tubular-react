...
describe('<GridHeader />', () => {
  ...
  describe('handleDatePicker()', () => {
    it('should update the state of \'firstFilterValue\' and \'firstFilterValue\'' +
      ...
      wrapper.instance().handleDatePicker({format: () => { return '2018-25-07T15:40:30-06:00'; }}, 'Value');
      wrapper.instance().handleDatePicker({format: () => { return '2018-25-07T15:40:30-06:00'; }}, 'Value2');
      wrapper.update();
